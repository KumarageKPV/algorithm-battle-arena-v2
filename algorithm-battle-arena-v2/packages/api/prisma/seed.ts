...
const problems = [
  ...
  },
  {
    ...
    description: [
      ...
      '',
      'Constraints',
      'The string consists of lowercase English letters and is between 1 and 1000 characters long.',
    ].join('\n'),
    difficultyLevel: 'Easy',
    category: 'String',
    timeLimit: 1,
    ...
    solutions: [
      {
        ...
        solutionText: [
          ...
          "console.log(s === reversed ? 'true' : 'false');",
        ].join('\n'),
      },
    ],
  },
  {
    ...
    description: [
      ...
      '',
      'Output Format',
      'Print the minimum integer in the array.',
      '',
      'Example',
      'Input:',
      '5',
  ...
  },
  {
    ...
    description: [
      ...
      '',
      'Output Format',
      'Print N lines. The i-th line should contain the i-th answer.',
      '',
      'Example',
      'Input:',
      '5',
